...
@section('content')
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			<div class="row" id="contact-main-container">
				<div class="col-md-12">
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							...
							<li class="email"><a href="mailto:info@yoursite.com">info@airfly.com</a></li>
							<li class="url"><a href="http://127.0.0.1:8000/">airfly.co</a></li>
						</ul>
					</div>
				</div>
				</div>
